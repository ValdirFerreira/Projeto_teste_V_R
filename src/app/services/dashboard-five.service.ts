...
export class DashBoardFiveService {
  ...
  carregarGraficoComparativoMarcas(filtro: FiltroPadrao) {
    return this.httpClient.post<Array<GraficoImagemPosicionamento>>(
      `${this.baseUrl}/DashBoardFive/CarregarGraficoComparativoMarcas/`,
      filtro
    );
  }


  carregarGraficoComparativoMarcasDinamico(filtro: FiltroPadrao) {
    return this.httpClient.post<Array<GraficoImagemPosicionamento>>(
      `${this.baseUrl}/DashBoardFive/CarregarGraficoComparativoMarcasDinamico/`,
      filtro
    );
  }
